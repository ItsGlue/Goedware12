...
public class SwordSwing : MonoBehaviour
{
    ...
    public float rotationOffset = 0f;       // Additional rotation offset to adjust sword's facing direction
    ...
    private void StartSwing()
    {
        ...
        // Apply the rotation offset to adjust the sword's facing direction
        midpointAngle += rotationOffset; 
