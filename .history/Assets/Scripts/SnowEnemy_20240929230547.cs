...
public class FrostEnemy : MonoBehaviour
{
    ...
    {
        // Check if the collider is tagged as an attack or projectile (adjust the tag as needed)
        if (collision.CompareTag("PlayerWeapon") || collision.CompareTag("Projectile"))
        {
            // Assuming projectiles or attacks have a script with a "damage" property
