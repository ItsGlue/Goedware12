...
public class ArrowShoot : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            // Hide the shooting sprite if the sword is active
            spriteRenderer.enabled = false; // Disable only the sprite renderer
            return; // Exit the Update method early
        }
        
        // Show the sprite when the sword is not active
